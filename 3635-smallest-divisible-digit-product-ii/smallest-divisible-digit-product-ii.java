...
class Solution {
  ...
  // Returns the prime count of t and if t is divisible by 2, 3, 5, 7 only.
  ...
  private Map<Integer, Integer> getFactorCount(Map<Integer, Integer> count) {
    final int count8 = count.get(2) / 3;      // 2^3 = 8
    final int remaining2 = count.get(2) % 3;
    final int count9 = count.get(3) / 2;      // 3^2 = 9
    ...
    // Combine 3 and 4 into 2 and 6 if both are present.
  ...
  // Returns a - b (element-wise, floored at 0).
